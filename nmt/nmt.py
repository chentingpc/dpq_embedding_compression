...
# KDQ related
tf.flags.DEFINE_string("kdq_type", "none", "one of none, vq, smx")
tf.flags.DEFINE_integer("K", 16, "K-way code.")
tf.flags.DEFINE_integer("D", 32, "D-dimensional code.")
tf.flags.DEFINE_integer("kdq_d_in", 0, "adjustable query embedding size for smx")
tf.flags.DEFINE_bool("kdq_share_subspace", False, "whether to share subspace")
tf.flags.DEFINE_bool("additive_quantization", False, "only work with smx")
