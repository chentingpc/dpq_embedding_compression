...
def ptb_raw_data(dataset="ptb", data_path=None, return_id2word=False):
    ...
    if dataset == "ptb":
        ...
        train_path = os.path.join(data_path, "text8.train.txt")
        valid_path = os.path.join(data_path, "text8.valid.txt")
        test_path = os.path.join(data_path, "text8.valid.txt")
    ...
    if return_id2word:
        ...
        return train_data, valid_data, test_data, vocabulary, id2word_list
    else:
